from utility_module import get_int, get_persoane_care_se_numesc, \
    ...
    get_people_with_at_least_one_vehicle_and_one_starship, get_pleople_with_at_least_a_minimal_height
...
while True:
    ...
    print("Introduceti 7 daca doriti sa afisati toate persoanele care au cel putin un vehicul si cel putin un starship")
    print("Introduceti 8 daca doriti sa afisati toate persoanele care au o inaltime minima data de dumneavoastra")
    ...
    if optiune is 1:
        ...
        get_people_with_at_least_one_vehicle_and_one_starship()
    elif optiune is 8:
        get_pleople_with_at_least_a_minimal_height()
    else:
        break
